...
const EditPasswordForm = () => {
    ...
    // disable submit if not match
    const passwordsMatch =
        !!newPasswordValue && !!confirmValue && newPasswordValue === confirmValue;

    const isSubmitDisabled = !isValid || !passwordsMatch;

    //   password error
    const hasError = Boolean(errors.password || errors.newPassword || errors.confirmNewPassword);

    const eyeOnEyeOff = (key) => {
        ...
        <div className="flex flex-col w-full items-center">
            ...
            >
              ...
              ${errors.confirmNewPassword
                ...
                {/* Rules */}
                <ol
                    className={`list-disc list-inside text-sm mb-6 w-[96%] rounded-xl px-4 py-2
            bg-white/0 backdrop-blur-xs border
            ${hasError
                            ...
                            : "text-white border-sky-300/35 shadow-[0_0_0_1px_rgba(110,200,255,0.35),0_0_18px_rgba(60,160,255,0.25),inset_0_0_18px_rgba(120,220,255,0.10)]"
                        }`}
                >
                    ...
                    <li>
                        One special character : <span>@ $ ! % * ? &</span>
                    </li>
              ...
              ${isSubmitDisabled
                                ? "bg-white/[0.03] border border-white/10 opacity-50 cursor-not-allowed shadow-none"
            ...
            `}
                    />
                    <button
                        className="rounded-xl px-10 py-1 text-white/60 w-[48%]
              ...
              hover:text-white/80 hover:border-white/15 transition"
                ...
                <div className="h-12 flex items-center">
                    {isPasswordUpdated ? (
                        <p
                            className="flex items-center gap-2 rounded-xl bg-[#3dff8f]/10 px-4 py-3 text-[#3dff8f]
